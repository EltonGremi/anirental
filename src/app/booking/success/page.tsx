  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
      <div className="bg-white rounded-2xl border border-gray-100 p-12 max-w-md text-center">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 mb-3">Richiesta inviata!</h1>
        <p className="text-gray-500 mb-2">
          La tua richiesta è stata ricevuta ed è in attesa di conferma.
        </p>
        <p className="text-gray-500 text-sm mb-8">
          Verrai contattato via Telegram o telefono per confermare i dettagli e l'anticipo.
        </p>
